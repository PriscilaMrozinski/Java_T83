...
public class Exemplo2 {
	...
	public static void main(String[] args) {
		...
		//Optional vazio
		Optional<String> optionalVazio = Optional.empty();//criou um Optional vazio
		...
		System.out.println("\n Obter o conteúdo de valor_indice_02: " + valor_indice_02.get());//usa o get para pegar o valor dentro do Optional
